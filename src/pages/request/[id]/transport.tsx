...
export default function TransportDetailsPage({ request, offer }: Props) {
    ...
    return (
        <main className="pb-12 px-4 max-w-[1250px] mx-auto">
            ...
            <h2 className="text-center text-secondary text-[16px] font-[400] mb-10">
            ...
            <div className="max-w-[760px] mx-auto flex flex-col gap-6">
                ...
                <div className="bg-white rounded-[8px] border border-line p-8">
                    ...
                    <div className="flex items-center justify-between pb-6 border-b border-surface">
                        <div className="flex items-center gap-4">
                            <div className="w-[52px] h-[52px] rounded-full bg-accent-soft flex items-center justify-center shrink-0">
                            ...
                            <div>
                                <p className="text-[16px] font-[600] text-ink">{offer.driverName || "Kierowca"}</p>
                                <p className="text-[13px] text-secondary mt-0.5">Zatwierdzona oferta</p>
                            </div>
                        </div>
                        <div className="text-right">
                            <p className="text-[11px] font-[600] uppercase tracking-wide text-secondary mb-0.5">Uzgodniona cena</p>
                            <p className="text-ink text-[26px] font-[700] leading-none">{offer.price} <span className="text-[16px] font-[500]">PLN</span></p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col -mx-8">
                        {offer.driverPhone && (
                            <a
                                ...
                                className="flex items-center gap-4 px-8 py-4 group hover:bg-[#F8F9FF] transition-colors border-b border-surface"
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="text-[11px] font-[600] uppercase tracking-wide text-secondary mb-0.5">Telefon</p>
                                    <p className="text-ink text-[15px] font-[600]">{offer.driverPhone}</p>
                                </div>
                                <span className="text-navy text-[13px] font-[500] shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">Zadzwoń →</span>
                            </a>
                        )}
                        {offer.driverEmail && (
                            <a
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="text-[11px] font-[600] uppercase tracking-wide text-secondary mb-0.5">E-mail</p>
                                    <p className="text-ink text-[15px] font-[600] truncate">{offer.driverEmail}</p>
                                </div>
                                <span className="text-navy text-[13px] font-[500] shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">Napisz →</span>
                            </a>
                        )}
                        {!offer.driverPhone && !offer.driverEmail && (
                            <p className="text-secondary text-[14px] px-8 py-4">Brak danych kontaktowych</p>
                        )}
                    </div>

                    {offer.message && (
                        <div className="mt-6 bg-accent-soft border border-[#C7D2F6] rounded-[8px] px-4 py-4">
                            <div className="flex items-center gap-2 mb-2">
                                <ChatBubble width={15} height={15} color="#0B298F" strokeWidth={1.8} className="shrink-0"/>
                                <span className="text-navy text-[11px] font-[600] uppercase tracking-wide">Wiadomość od kierowcy</span>
                            </div>
                ...
                {offer.vehicle && (
                    <div className="bg-white rounded-[8px] border border-line p-8">
                        ...
                        <div className="pb-6 border-b border-surface">
                            <p className="text-ink text-[20px] font-[700]">{offer.vehicle.name}</p>
                        ...
                        {offer.vehicle.photos && offer.vehicle.photos.length > 0 && (
                            <div className="-mx-8 border-b border-surface">
                        ...
                        <div className="flex flex-col -mx-8">
                            <div className="flex items-center gap-4 px-8 py-4 border-b border-surface">
                                ...
                                <div>
                                    <p className="text-[11px] font-[600] uppercase tracking-wide text-secondary mb-0.5">Typ pojazdu</p>
                                    <p className="text-ink text-[15px] font-[600]">{vehicleTypeLabels[offer.vehicle.type] || offer.vehicle.type}</p>
                                </div>
                            </div>
                            <div className={`flex items-center gap-4 px-8 py-4 ${(offer.vehicle.hasWifi || offer.vehicle.hasWC || offer.vehicle.hasTV || offer.vehicle.hasAirConditioning) ? "border-b border-surface" : ""}`}>
                                <div className="w-[40px] h-[40px] rounded-full bg-accent-soft flex items-center justify-center shrink-0">
                                    <DirectorChair width={18} height={18} color="#0B298F" strokeWidth={1.8}/>
                                </div>
                                <div>
                                    <p className="text-[11px] font-[600] uppercase tracking-wide text-secondary mb-0.5">Liczba miejsc</p>
                                    <p className="text-ink text-[15px] font-[600]">{offer.vehicle.seats} miejsc</p>
                                </div>
                            </div>
                            {(offer.vehicle.hasWifi || offer.vehicle.hasWC || offer.vehicle.hasTV || offer.vehicle.hasAirConditioning) && (
                                <div className="flex items-start gap-4 px-8 py-4">
                                    <div className="w-[40px] h-[40px] rounded-full bg-accent-soft flex items-center justify-center shrink-0 mt-0.5">
                                        <Sparks width={18} height={18} color="#0B298F" strokeWidth={1.8}/>
                                    </div>
                                    <div>
                                        <p className="text-[11px] font-[600] uppercase tracking-wide text-secondary mb-2">Wyposażenie</p>
                ...
                <div className="bg-white rounded-[8px] border border-line p-8">
                    ...
                    {route && (
                        <div className="pb-6 mb-2 border-b border-surface">
                            <p className="text-[11px] font-[600] uppercase tracking-wide text-secondary mb-5">Trasa przejazdu</p>
                            <div className="flex flex-col">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="pb-5 flex-1">
                                        <p className="text-[11px] font-[600] uppercase tracking-wide text-secondary mb-0.5">Miejsce wyjazdu</p>
                                        <p className="text-ink text-[15px] font-[600]">{route.origin?.address}</p>
                                    </div>
                                </div>
                                {route.waypoints?.map((wp: { address: string }, i: number) => (
                                    <div key={i} className="flex items-start gap-4">
                                        ...
                                        <div className="pb-5 flex-1">
                                            <p className="text-[11px] font-[600] uppercase tracking-wide text-secondary mb-0.5">Przystanek #{i + 1}</p>
                                            <p className="text-ink text-[15px] font-[600]">{wp.address}</p>
                                        </div>
                                    </div>
                                ))}
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-[11px] font-[600] uppercase tracking-wide text-secondary mb-0.5">Lokalizacja końcowa</p>
                                        <p className="text-ink text-[15px] font-[600]">{route.destination?.address}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col -mx-8">
                        <div className="flex items-center gap-4 px-8 py-4 border-b border-surface">
                            ...
                            <div>
                                <p className="text-[11px] font-[600] uppercase tracking-wide text-secondary mb-0.5">Data wyjazdu</p>
                                <p className="text-ink text-[15px] font-[600]">{request.date}</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-4 px-8 py-4 border-b border-surface">
                            <div className="w-[40px] h-[40px] rounded-full bg-accent-soft flex items-center justify-center shrink-0">
                            ...
                            <div>
                                <p className="text-[11px] font-[600] uppercase tracking-wide text-secondary mb-0.5">Godzina wyjazdu</p>
                                <p className="text-ink text-[15px] font-[600]">{request.time}</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-4 px-8 py-4">
                            ...
                            <div>
                                <p className="text-[11px] font-[600] uppercase tracking-wide text-secondary mb-0.5">Pasażerowie</p>
                                <p className="text-ink text-[15px] font-[600]">
                                    {request.adults + request.children} os.{" "}
                                    <span className="text-[14px] text-secondary font-[400]">
    ...
    return {
        props: {
            ...
            offer: {
                ...
                ...(acceptedOffer.driverName && { driverName: acceptedOffer.driverName }),
                ...(acceptedOffer.driverEmail && { driverEmail: acceptedOffer.driverEmail }),
                ...(acceptedOffer.driverPhone && { driverPhone: acceptedOffer.driverPhone }),
