                ...
                <li
                    ...
                    className={`flex items-start gap-[10px] py-2 last:border-b-0 text-[14px] leading-[1.6] ${
                        light
                            ...
                            : "border-b border-chrome text-muted"
                    }`}
                >
                    <span className={`w-[6px] h-[6px] rounded-full shrink-0 mt-[7px] ${light ? "bg-blue-alt" : "bg-navy"}`} />
                    {item}
                </li>
            ))}
        </ul>
        ...
        <div>
            ...
            <div className="bg-dark px-6 py-[72px] relative overflow-hidden">
                ...
                <div className="max-w-[1100px] mx-auto relative z-10">
                    ...
                    <h1 className="text-[clamp(26px,3.8vw,44px)] font-[600] text-white leading-[1.17] tracking-[-0.025em] mb-[18px] max-w-[660px]">
                        ...
                        i <em className="text-blue-alt not-italic">przewozów okazjonalnych</em>
                    </h1>
            ...
            <div className="bg-white">
                <div className="max-w-[1100px] mx-auto px-6 py-[72px]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            <p className="text-[14px] text-muted leading-[1.72] mb-[14px]">
                            ...
                            <p className="text-[13px] font-[600] text-foreground mb-[10px]">Wayoo umożliwia:</p>
                        ...
                        <div className="bg-white border border-chrome rounded-xl p-[26px] flex flex-col justify-center hover:shadow-[0_6px_28px_rgba(18,18,42,.07)] hover:-translate-y-0.5 transition-all duration-200">
                            <div className="text-[22px] mb-[14px]">🔄</div>
                            <h3 className="text-[15.5px] font-[600] text-foreground mb-2">Jedno zapytanie — wielu przewoźników</h3>
                            <p className="text-[13.5px] text-muted leading-[1.68]">
                        ...
                        <div className="bg-[#fff5f5] border border-[#fecaca] rounded-xl p-[26px]">
                            ...
                            {["szukanie przewoźników na własną rękę", "wiele telefonów i ustaleń", "brak uporządkowanego procesu"].map((item) => (
                                <div key={item} className="flex gap-[10px] items-start py-2 border-b border-black/6 last:border-b-0">
                                    <div className="w-5 h-5 rounded-full bg-badge-error-bg text-[#991b1b] text-[9px] font-[800] flex items-center justify-center shrink-0 mt-[2px]">✕</div>
                                    <span className="text-[13.5px] text-muted leading-[1.5]">{item}</span>
                                </div>
                            ))}
                        </div>
                        {/* Dobry */}
                        <div className="bg-dark rounded-xl p-[26px]">
                            ...
                            {["jedno zapytanie zamiast wielu telefonów", "organizacja transportu w jednym systemie", "przejrzysty proces od zapytania do przejazdu"].map((item) => (
                                <div key={item} className="flex gap-[10px] items-start py-2 border-b border-white/6 last:border-b-0">
                                    <div className="w-5 h-5 rounded-full bg-navy text-white text-[9px] font-[800] flex items-center justify-center shrink-0 mt-[2px]">✓</div>
            ...
            <div className="bg-white">
                <div className="max-w-[1100px] mx-auto px-6 py-[72px]">
                    ...
                    <div className="border-2 border-navy rounded-xl p-[34px] relative bg-white mt-6 max-w-[760px]">
                        <span className="absolute -top-[13px] left-6 bg-navy text-white text-[10px] font-[800] tracking-[.09em] uppercase px-3 py-[3px] rounded-[20px]">
                            MISJA WAYOO
                        </span>
                        <p className="text-[16px] text-foreground leading-[1.78]">
                            Łączymy zapotrzebowanie na przewozy grupowe z profesjonalnymi firmami transportowymi.
                        </p>
                        <p className="text-[14px] text-muted mt-3">Zamówienie transportu dla grup staje się szybkie i wygodne.</p>
                        <p className="text-[13px] font-[600] text-foreground mt-4 mb-2">Zapewniamy:</p>
            ...
            <div className="bg-white">
                <div className="max-w-[1100px] mx-auto px-6 py-[72px]">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {values.map((v) => (
                            <div key={v.title} className="bg-white border border-chrome border-t-[3px] border-t-[#0B298F] rounded-xl p-6">
                                <h4 className="text-[15px] font-[600] text-foreground mb-[7px]">{v.title}</h4>
                                <p className="text-[13.5px] text-muted leading-[1.68]">{v.desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <div className="bg-faint">
                <div className="max-w-[1100px] mx-auto px-6 py-[72px]">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-[10px]">
                        {forWhom.map((item) => (
                            <div key={item} className="bg-faint rounded-lg px-[18px] py-[14px] flex items-center gap-3 hover:bg-gray-light transition-colors">
                                <div className="w-2 h-2 rounded-full bg-navy shrink-0" />
                                <span className="text-[14px] font-[500] text-foreground">{item}</span>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <div className="bg-white">
                <div className="max-w-[1100px] mx-auto px-6 py-[72px]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            <p className="text-[14px] text-muted leading-[1.72] mb-[14px]">Budujemy ogólnopolski system transportu grupowego, który:</p>
                        ...
                        <div>
                            <p className="text-[14px] font-[600] text-foreground leading-[1.72] mb-[14px]">Kierunek zmian w branży transportowej</p>
                            <p className="text-[14px] text-muted leading-[1.72] mb-[14px]">W branży transportowej rośnie znaczenie:</p>
            ...
            <div className="bg-faint">
                <div className="max-w-[1100px] mx-auto px-6 py-[80px] text-center">
                    <p className="text-[14px] text-muted mb-[10px] font-[600] uppercase tracking-[.08em]">Wayoo — nowoczesny transport grupowy</p>
                    <h2 className="text-[clamp(26px,4vw,44px)] font-[700] tracking-[-0.03em] text-foreground leading-[1.18] mb-[14px]">
                        Tworzymy system, który<br />upraszcza organizację<br />
                        <em className="text-navy not-italic">przewozów grupowych.</em>
                    </h2>
                    <p className="text-[16px] text-muted mb-8">Wayoo. I transport staje się prosty.</p>
                    <div className="flex gap-3 justify-center flex-wrap">
                        <Link href="/" className="bg-navy hover:bg-navy-dark text-white text-[14px] font-[600] px-6 h-12 rounded-lg inline-flex items-center transition-colors">
                            Zarezerwuj transport →
                        </Link>
                        <Link href="/for-hotels" className="bg-transparent border border-chrome text-foreground text-[14px] font-[500] px-6 h-12 rounded-lg inline-flex items-center hover:bg-gray-light transition-colors">
                            Oferta dla hoteli
                        </Link>
                        <Link href="/become-driver" className="bg-transparent border border-chrome text-foreground text-[14px] font-[500] px-6 h-12 rounded-lg inline-flex items-center hover:bg-gray-light transition-colors">
                            Współpraca z Wayoo
                        </Link>
                    </div>
                </div>
