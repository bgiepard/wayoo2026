        ...
        <div>
            ...
            <div className="bg-dark px-6 py-[72px] relative overflow-hidden">
                ...
                <div className="max-w-[1100px] mx-auto relative z-10">
                    ...
                    <h1 className="text-[clamp(26px,3.8vw,44px)] font-[600] text-white leading-[1.17] tracking-[-0.025em] mb-[18px] max-w-[660px]">
                        ...
                        dla <em className="text-blue-alt not-italic">podróży grupowych</em>
                    </h1>
                    ...
                    <div className="flex bg-white/7 border border-white/14 rounded-lg p-[5px] gap-[2px] max-w-[580px]">
                        ...
                        <Link
                            href="/"
                            className="bg-navy hover:bg-navy-dark text-white text-[14px] font-[600] rounded-lg px-6 flex items-center whitespace-nowrap transition-colors"
                        >
                            Dalej →
                        </Link>
                    </div>
            ...
            <div className="bg-white">
                <div className="max-w-[1100px] mx-auto px-6 py-[72px]">
                    ...
                    <p className="text-[16px] text-muted max-w-[580px] mb-11 leading-[1.72]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            <p className="text-[14px] text-muted leading-[1.72] mb-4">
                            ...
                            <p className="text-[13px] font-[600] text-foreground mb-[10px]">Dotyczy to m.in.:</p>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            {cards.map((card) => (
                                <div
                                    key={card.title}
                                    className="bg-white border border-chrome rounded-xl p-[26px] hover:shadow-[0_6px_28px_rgba(18,18,42,.07)] hover:-translate-y-0.5 transition-all duration-200"
                                >
                                    <div className="text-[22px] mb-[14px]">{card.icon}</div>
                                    <h3 className="text-[15.5px] font-[600] text-foreground mb-2">{card.title}</h3>
                                    <p className="text-[13.5px] text-muted leading-[1.68]">{card.desc}</p>
                                </div>
                            ))}
                        </div>
                    </div>
            ...
            <div className="bg-faint">
                <div className="max-w-[1100px] mx-auto px-6 py-[72px]">
                    <p className="text-[11px] font-[700] tracking-[.1em] uppercase text-navy mb-[10px]">Jak to działa</p>
                    <h2 className="text-[clamp(22px,3vw,32px)] font-[600] tracking-[-0.022em] text-foreground leading-[1.22] mb-3">
            ...
            <div className="bg-white">
                <div className="max-w-[1100px] mx-auto px-6 py-[72px]">
                    <p className="text-[11px] font-[700] tracking-[.1em] uppercase text-navy mb-[10px]">Transport dopasowany do każdej podróży</p>
                    <h2 className="text-[clamp(22px,3vw,32px)] font-[600] tracking-[-0.022em] text-foreground leading-[1.22] mb-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {useCases.map((uc) => (
                            <div key={uc.title} className="bg-faint rounded-xl p-[22px] flex gap-[14px] hover:bg-gray-light transition-colors">
                                <div className="w-[42px] h-[42px] rounded-[10px] bg-white border border-chrome flex items-center justify-center text-[20px] shrink-0">
                                    {uc.icon}
                                </div>
                                <div>
                                    <h4 className="text-[14px] font-[600] text-foreground mb-[6px]">{uc.title}</h4>
                                    <p className="text-[13px] text-muted leading-[1.65]">{uc.desc}</p>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <div className="bg-faint">
                <div className="max-w-[1100px] mx-auto px-6 py-[72px]">
                    <p className="text-[11px] font-[700] tracking-[.1em] uppercase text-navy mb-[10px]">Planowanie z wyprzedzeniem</p>
                    <h2 className="text-[clamp(22px,3vw,32px)] font-[600] tracking-[-0.022em] text-foreground leading-[1.22] mb-11">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 items-start">
                        <div>
                            ...
                            <p className="text-[13px] font-[600] text-foreground mb-[10px]">Jest to szczególnie pomocne w przypadku:</p>
                        ...
                        <div>
                            <p className="text-[13px] font-[600] text-foreground mb-[10px]">Transport grupowy najczęściej organizowany jest dla:</p>
