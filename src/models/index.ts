...
// Oblicza dystans w km między dwoma punktami (wzór Haversine)
...
// Oblicza łączny dystans trasy (origin → waypoints → destination) w km
...
export type RequestStatus =
  ...
  | 'accepted'   // Oferta wybrana przez pasażera
